	...
	if(!global._pause){
		if(_freeze > 0){
			...
			if(_timer > 1){
				...
				image_xscale = ((global._scale*_scale)+0.2)*_curdir;
				image_yscale = (global._scale*_scale)+0.2;
		
				if(_truescale){
					image_xscale = _scale*_curdir;
					image_yscale = _scale*_curdir;
				}
			...
			switch(_type){
				case "smile":
					_start_xscale = ((global._scale*_scale)+0.2)*_curdir;
					_start_yscale = (global._scale*_scale)+0.2;
