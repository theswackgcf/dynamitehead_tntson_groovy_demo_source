///function voice_play_overlap_proximity(sound_index, [volume], [point_x], [point_y])
function voice_play_overlap_proximity(sfx, gain = 1.0, point_x = global._cameraX+(WIDTH/2), point_y = global._cameraY+(HEIGHT/2)){
